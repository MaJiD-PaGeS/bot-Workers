...
// 设置优选地址api接口
// let addressesapi = ['https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/MaJiDcT/IP'];
let addressesapi = ['addressapi'];

let DLS = 4;//速度下限
let addressescsv = [
	//'https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/MaJiDcT/MaJiDcT/vip/IP.csv' //iptest测速结果文件。
];

let subconverter = "api.v1.mk"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
let subconfig = "https://raw.githubusercontent.com/MaJiD-PaGeS/sub-ip/main/Clash/config/ACL4SSR_Online_Full_MultiMode.ini"; //订阅配置文件
